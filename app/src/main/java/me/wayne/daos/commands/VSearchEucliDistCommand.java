...
public class VSearchEucliDistCommand extends AbstractCommand<List<Pair<String, Double>>> {

    public VSearchEucliDistCommand() {
        super("VSEARCH.EUCLIDIST", 3);
    }
    ...
    protected List<Pair<String, Double>> processCommand(StorePrintWriter out, @Nullable UUID requestUuid, String inputLine, List<String> args) {
        ...
        return vectorDB.findKNearestNeighborsoUsingEuclideanDistance(values, k);
    }
